...
int main()
{
	...
	// ------------------------------------
	Shader ourShader("shader.5.vs", "shader.5.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//view = glm::lookAt(cameraPos, glm::vec3(0.0f, 0.0f, -0.8f), cameraUp);
...
void mouse_callback(GLFWwindow* window, double xpos, double ypos)
{
	...
	glm::vec3 front;
	front.x = 1000*cos(glm::radians(yaw)) * cos(glm::radians(pitch));
	front.y = 1000*sin(glm::radians(pitch));
	front.z = 1000*sin(glm::radians(yaw)) * cos(glm::radians(pitch));
